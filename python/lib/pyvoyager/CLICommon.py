...
NOTIF_CATEGORY_DICT = {
    ...
    'EVENTS': ["alarmOpened", "alarmClosed", "cmdFinished", "invalidMIC", "joinFailed", "moteStateChanged", "pathStateChanged", "pathAlert", "serviceChanged", "packetSent", "pingResponse", "optPhase"],
