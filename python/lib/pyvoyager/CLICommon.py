...
NOTIF_CATEGORY_DICT = {
    ...
    'EVENTS': ["alarmOpened", "alarmClosed", "bbStateChanged", "cmdFinished", "invalidMIC", "joinFailed", "moteStateChanged", "pathStateChanged", "pathAlert", "serviceChanged", "packetSent", "pingResponse"],
